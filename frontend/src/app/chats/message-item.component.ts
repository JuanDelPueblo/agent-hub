...
@Component({
  ...
  styles: `
    ...
    .thought { padding: 10px 12px; border: 1px dashed var(--mat-sys-outline-variant); border-radius: var(--mat-sys-corner-medium); color: var(--mat-sys-on-surface-variant); }
    .thought summary { display: flex; align-items: center; gap: 7px; cursor: pointer; font: var(--mat-sys-label-large); }
    .thought summary mat-icon { width: 19px; height: 19px; font-size: 19px; }
    .thought > div { margin-top: 9px; padding-top: 9px; border-top: 1px solid var(--mat-sys-outline-variant); white-space: pre-wrap; overflow-wrap: anywhere; font: var(--mat-sys-body-medium); }
