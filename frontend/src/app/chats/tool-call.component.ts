...
@Component({
  ...
  `,
  styles: `
    :host { display: block; margin: 8px 0; } .tool { border: 1px solid var(--mat-sys-outline-variant); box-shadow: none; } mat-panel-title, mat-panel-description { display: flex; align-items: center; gap: 8px; } mat-panel-title mat-icon { color: var(--mat-sys-primary); } mat-panel-description { justify-content: flex-end; font: var(--mat-sys-label-medium); } pre { max-height: 260px; overflow: auto; margin: 0; padding: 14px; border-radius: var(--mat-sys-corner-small); background: var(--mat-sys-surface-container-lowest); white-space: pre-wrap; overflow-wrap: anywhere; font: .82rem/1.45 ui-monospace, SFMono-Regular, Consolas, monospace; }
  `,
})
